                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="pruductname" placeholder="Product Name">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <select  name="product" class="form-control form-select select2" data-bs-placeholder="Select Country">
